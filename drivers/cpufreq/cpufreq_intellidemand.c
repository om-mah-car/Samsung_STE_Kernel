...
#define DEF_STEP_UP_EARLY_HISPEED		(1000000)
#define DEF_STEP_UP_INTERIM_HISPEED		(1100000)
...
#define SUP_SLOW_UP_FREQUENCY 		(1000000)
#define SUP_HIGH_SLOW_UP_FREQUENCY 	(1100000)
